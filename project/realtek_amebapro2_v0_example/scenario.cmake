...
elseif(DEFINED APPLICATION AND APPLICATION)
	message(STATUS "Building APPLICATION at ${app_root}")
	if(EXISTS ${app_root}/application.cmake)
		message(STATUS "Found application.cmake")
		include(${app_root}/application.cmake)
	else()
		message(WARNING "application.cmake does not exist")
	endif()
	if(NOT DEBUG)
		set(APPLICATION OFF CACHE STRING INTERNAL FORCE)
	endif()
else()
endif()
